export const fakeData = [
...

	{
		...
		image: 'https://i1.sndcdn.com/artworks-000658270138-v1iolx-t240x240.jpg',
		post: 'Discovered a new star system in Galactic Explorers today. The universe is vast! 🌌✨',
		downloads: '23',
		views: '789'
	},

	{
		...
		image: 'https://assets-prd.ignimgs.com/2022/05/17/mysticquest-1652747577625.jpg',
		post: 'Solved the riddle of the Sphinx in Mystic Quests. Feeling accomplished! 🧙‍♀️🔮',
		downloads: '45',
		views: '643'
	},

	{
		...
		image: 'https://upload.wikimedia.org/wikipedia/en/2/20/Cover_of_Dungeon_Delve_supplement.png',
		post: "Survived the treacherous depths of Dungeon Delve. Who's up for a challenge? 💀⚔️",
		downloads: '34',
		views: '532'
	},

	{
		...
		post: 'Sharing the beauty of Enchanted Gardens.🌷🌿',
		downloads: '67',
		views: '987'
	},

	{
		...
		post: "Reached the highest peak in Skyborne Odyssey. The sky's the limit! ☁️🏞️",
		downloads: '78',
		views: '1201'
	},

	{
		...
		post: 'Built a sprawling city in Pixel Pioneers. Hard work pays off! 🏙️🎮',
		downloads: '89',
		views: '1456'
	},

	{
		...
		post: "Conquered all rival kingdoms in King's Gambit. Long live the king! 👑🏰",
		downloads: '56',
		views: '1002'
	},

	{
		...
		image: 'https://www.pubgmobile.com/images/event/common/icon.png',
		post: 'Explored the mystical realm of Fairytail Adventures. Never too old for fairytales! 🧚‍♀️📚',
		downloads: '43',
		views: '789'
	},

	{
		...
		post: 'Hacked through enemy lines in Robo Recon. The future of warfare is here! 🤖🔥',
		downloads: '65',
		views: '1098'
	}
];
